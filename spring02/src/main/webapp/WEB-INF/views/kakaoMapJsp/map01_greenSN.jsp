...
=> Javascript 키 : edb9c9a65b8c9d6e46d5fd545185ba40 (내 어플리케이션 키)
...
<script type="text/javascript" 
	    src="//dapi.kakao.com/v2/maps/sdk.js?appkey=edb9c9a65b8c9d6e46d5fd545185ba40&libraries=services">
</script>	

</head>
<body>
<h2>Welcome! 그린컴퓨터아카데미 </h2>
<font color="gray"><b>경기도 성남시 분당구 미금일로154번길 20 2001아울렛분당점, 대표번호: 031.712.7447</b></font><br>
<br>
...
let address = '경기도 성남시 분당구 미금일로154번길 20 2001아울렛분당점' ;
let description = '아울렛 2001' ; // description: 설명,묘사
